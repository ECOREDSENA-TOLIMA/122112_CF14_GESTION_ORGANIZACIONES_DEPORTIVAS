  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Conceptualización de documentos de soporte y normativas contables
        p.mb-4 Explicar los conceptos sobre documentos de soporte, regulaciones y objetivos en el ámbito de la contabilidad y registros financieros.
